      ...
      <div className="relative w-full h-[75vh]">
        <Slider {...settings} className="w-full h-full">
          {cars.map((car, index) => (
            ...
            >
              <h1
                className="opacity-80 top-[calc(50%-20px)] 2xl:top-[calc(50%-120px)] xl:top-[calc(50%-80px)] lg:top-[calc(50%-60px)] md:top-[calc(50%-40px)] sm:top-[calc(50%-20px)] 2xl:text-[15vw] xl:text-[15rem] lg:text-[12rem] md:text-[10rem] sm:text-[8rem] text-[20vw] scale-x-125 scale-y-[1.5]  text-[#000000] absolute thunder left-1/2 transform -translate-y-1/2 -translate-x-1/2 -z-10 text-wrap text-center text-transparent "
                style={{
